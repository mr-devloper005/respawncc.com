...
export const editableRootStyle = {
  '--slot4-page-bg': '#f3f7f8',
  '--slot4-page-text': '#212121',
  '--slot4-panel-bg': '#e9f0f1',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#617074',
  '--slot4-soft-muted-text': '#879396',
  '--slot4-accent': '#0d7377',
  '--slot4-accent-fill': '#0d7377',
  '--slot4-accent-soft': '#d7fffb',
  '--slot4-on-accent': '#ffffff',
  '--slot4-dark-bg': '#071a2b',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#dfe8e9',
  '--slot4-cream': '#ffffff',
  '--slot4-warm': '#edf3f4',
  '--slot4-lavender': '#d7fffb',
  '--slot4-gray': '#e9f0f1',
  '--slot4-body-gradient': 'radial-gradient(circle at 85% 5%, rgba(20,255,236,.08), transparent 24rem)',
  '--editable-page-bg': '#f3f7f8',
  '--editable-page-text': '#212121',
  '--editable-container': '1320px',
  '--editable-border': '#d8e2e3',
  '--editable-nav-bg': '#ffffff',
  '--editable-nav-text': '#071a2b',
  '--editable-nav-active': '#0d7377',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#0d7377',
  '--editable-cta-text': '#ffffff',
  '--editable-search-bg': '#ffffff',
  '--editable-footer-bg': '#071a2b',
